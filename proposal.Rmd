...
Additionally, we will explore the possibility of merging multiple datasets to add in a columns like stating a movie's budget. This can be done through using the join methods. Joined information could help explain a movie's rating/revenue. 